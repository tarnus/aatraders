...
<ul>
      ...
      <li><a href="demo2_simple_with_params.php">demo2 - demo with few parameters</a></li>
      ...
      <li><a href="demo5_customized_style.php">demo5 - demo with a customized style (theme)</a></li>
