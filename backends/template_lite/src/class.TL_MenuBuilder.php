...
/**
 * Project:	 TL_MenuBuilder: CSS Menus for the Template Lite Template Engine
 * File:		class.TL_MenuBuilder.php
 *
 ...
 * @version 1.1
 *
 * Modified for use with Template lite 29 July 2007
 * @copyright 2007 Mark Dickenson (changes only)
 * @author Mark Dickenson
 * @package TL_MenuBuilder
 * @version 1.2
 */


class TL_MenuBuilder {

	/**
	 * Class Constructor
	 */
	function TL_MenuBuilder() { }
	...
	function loadMenu($name) {
		return isset($_SESSION['TLMENU'][$name]) ? $_SESSION['TLMENU'][$name] : false;
	}	
	 ...
	 * @param string $class the class text
	 */
	function setItemTarget(&$item, $target) {
		$item['target'] = $target;
	}
