...
<tr bgcolor="#52ACEA">
    ...
    <td colspan="6" height="1"><img src="templates/{$templatename}images/spacer.gif" width="1" height="1"></td>

  </tr>  
  <tr bgcolor="#000000">
    <td width="31" height="1"><img src="templates/{$templatename}images/spacer.gif" width="31" height="1"></td>
    <td   colspan="4"><img src="templates/{$templatename}images/spacer.gif" width="250" height="1"></td>
    
    <td width="12" height="1"><img src="templates/{$templatename}images/spacer.gif" width="12" height="1"></td>

  </tr>
  <tr bgcolor="#000000">
    <td  align="right" width="31" height="20"><img src="templates/{$templatename}images/spacer.gif" width="31" height="20"></td>
    <td   align="left" colspan="2" ID="IEshout1"><img src="templates/{$templatename}images/spacer.gif" width="250" height="1"><br><div style="border-style: dotted1none; border-color:white" id=scroll3 dir=rtl ;overflow:auto>
{literal}
...
{/literal}
    ...
    <td ID="IEfad1" align="right" colspan="2"><img src="templates/{$templatename}images/spacer.gif" width="250" height="1"><br><div style="border-style: dotted1none; border-color:white" id=scroll3 dir=rtl ;overflow:auto>
{literal}
<SCRIPT LANGUAGE="JavaScript1.2" TYPE="text/javascript">
<!--
...
{/literal}
    ...
    <td><img src="templates/{$templatename}images/spacer.gif" width="12" height="20"></td>
  </tr>
  <tr bgcolor="#52ACEA">
...
{/php}
  ...
  <tr bgcolor="#2A2A2A">
    ...
    <td colspan="6" height="3"><img src="templates/{$templatename}images/spacer.gif" width="1" height="3"></td>
...
<tr bgcolor="#52ACEA">
    ...
    <td colspan="5" height="1"><img src="templates/{$templatename}images/spacer.gif" width="1" height="1"></td>
...
<table border="1" cellspacing="0" cellpadding="0" align="left" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;"><tr><td><table  border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#000000" width="175">
  ...
  <tr>
    <td><img src="templates/{$templatename}images/spacer.gif" width="10" height="21"></td>
...
<table  border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#000000" width="175">
  ...
  <tr>
    <td><img src="templates/{$templatename}images/spacer.gif" width="10" height="21"></td>
    <td bgcolor="#000000"><font face="verdana" size="1" color="#ffffff"><b>
<a class=mnu href="javascript:OpenSB()">{$shoutboxtitle}</a>
</b></font></td>
    <td><img src="templates/{$templatename}images/spacer.gif" width="10" height="21"></td>
  </tr>
  <tr>
