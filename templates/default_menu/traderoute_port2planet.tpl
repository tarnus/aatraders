	...
	<tr align=center bgcolor="#400040">
		...
		<td width="50%" valign="top">
			...
			<img src="templates/{$templatename}images/spacer.gif" width="100%" height="7" alt="px" />
                ...
                <b>{$l_tdr_start} {$source_commodity}: {$destination_commodity_start}</b><br>
                	<b>{$l_tdr_start} {$destination_commodity}: {$destination_commodity2_start}</b>
			</p>
		</td>
	</tr>
	<tr align=center bgcolor="#400040">
		...
		<td width="50%" valign="top">
			...
			<b>{$l_tdr_finish} {$source_commodity}: {$destination_commodity_total}</b><br>
                	<b>{$l_tdr_finish} {$destination_commodity}: {$destination_commodity2_total}</b>
			</p>
		</td>
	</tr>
	<tr align=center bgcolor="#400040">
