                ...
                <tr>
                  <td colspan="2"><div class="hr"><hr /></div>
						<table align="center" border="0" cellpadding="4" cellspacing="0">
							<TR>
							    <TD COLSPAN=2 align="center"><FONT FACE="Arial,Helvetica" class="artSHead"><B>Thanks for your comment or question.  We will address any questions and email you with our response.</B></font><BR></TD>
							</TR>		
							<tr>
