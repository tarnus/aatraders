...
<TR><TD>{$l_mt_subject}</TD><TD><INPUT TYPE=TEXT NAME=subject SIZE=80 MAXLENGTH=80 VALUE="{$subject}"></TD></TR>
<TR><TD>{$l_mt_message}</TD><TD><TEXTAREA NAME=content ROWS=10 COLS=80>{$message}</TEXTAREA></TD></TR>
