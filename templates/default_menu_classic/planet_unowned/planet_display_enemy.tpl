...
<tr><td>{if $planetowner != 3}
		...
		{if $enable_spies == 1}
			{if $numspies != 0}
				...
				<TR BGCOLOR="#000000"><TD colspan=99 align=center><font color=white><B>{$l_spy_yourspies} </font> ({$numspies})
				{if $addaspy == 1}
				...
				<TR BGCOLOR="#000000"><TD>&nbsp;</TD><TD align="center"><B>{$l_planetary_SD_weapons}</B></TD><TD align="center"><B>{$l_planetary_SD_sensors}</B></TD><TD align="center"><B>{$l_planetary_SD_cloak}</B></TD></TR>
				<TR BGCOLOR="#000000"><TD>{$l_planetary_defense_levels}&nbsp;</TD>
				...
				<TR BGCOLOR="#000000"><TD>&nbsp;</TD><TD align="center"><B>{$l_ore}</B></TD><TD align="center"><B>{$l_organics}</B></TD><TD align="center"><B>{$l_goods}</B></TD><TD align="center"><B>{$l_energy}</B></TD><TD align="center"><B>{$l_colonists}</B></TD><TD align="center"><B>{$l_credits}</B></TD><TD align="center"><B>{$l_fighters}</B></TD><TD align="center"><B>{$l_torps}</B></TD>
				...
				<TR BGCOLOR="#000000"><TD>{$l_planet_perc}</TD>
