  ...
  <a href=spy.php?command=detect>{$l_clickme}</a> {$l_spy_messages}<BR><BR>
	...
	{if $spycount}
		...
		{if $enemyshipspycount}
			<table border="0" cellpadding="2" cellspacing="0" width="100%" class="border">
				<tr>
					<td bgcolor="#000000" colspan=6 align=center><font color=white><b>{$l_spy_defaulttitle1}</b></font></td>
				</tr>
				<tr>
					...
					<td bgcolor="#000000"><span class="white"><b>{$l_spy_shiplocation}</b></span></td>
		...
		{if $planetspycount}
			<table border="0" cellpadding="2" cellspacing="0" width="100%" class="border">
				<tr>
					<td bgcolor="#000000" colspan=7 align=center><font color=white><b>{$l_spy_defaulttitle2}</b></font></td>
				</tr>
				<tr>
		...
		{if $myplanetspycount}
			<table border="0" cellpadding="2" cellspacing="0" width="100%" class="border">
				<tr>
					<td bgcolor="#000000" colspan=3 align=center><font color=white><b>{$l_spy_defaulttitle3}</b></font></td>
				</tr>
				<tr>
