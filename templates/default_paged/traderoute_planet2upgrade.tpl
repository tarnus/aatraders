	...
	<tr bgcolor="#400040">
		<td colspan=2 align="center" valign="top">
			<table width="100%" border="0" cellspacing="3">
              ...
              <tr>
                <td width="50%" valign="top"><b>{$l_tdr_planet} {$l_fighters}: {$total_fighters_bought}</b></td>
                <td width="50%" valign="top"><b>{$l_fighters} {$l_tdr_sold}: {$total_fighters_dumped} @ {$fighter_price} {$l_tdr_credits}</b></td>
              </tr>
              <tr>
                <td width="50%" valign="top"><b>{$l_tdr_planet} {$l_torps}: {$total_torps_bought}</b></td>
                <td width="50%" valign="top"><b>{$l_torps} {$l_tdr_sold}: {$total_torps_dumped} @ {$torpedo_price} {$l_tdr_credits}</b></td>
              </tr>
              <tr>
