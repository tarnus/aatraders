  ...
  <tr>
    ...
    <td bgcolor="#000000" valign="top" align="center" colspan=2>
			...
			<tr>
			  <td width="100%" bgcolor="black">
				<div align="center">
				  <table border="0" cellspacing="1" width="100%">
					<tr>
					  <td width="75%" align="left"><font color="white" size="2"><b>{$forumname}</b></font></td>
		...
		{if $istopics}
			...
			echo "		  <td width=\"50%\" align=\"center\" ><a href=\"casino.php?casinogame=casino_forums&command=readtopic&topic_id=$topicid[$i]#$postid[$i]\"><font color=\"white\" size=\"2\"><b>$topictypes[$i] $topictitle[$i]</b></font></a></td>";
			  ...
			  <td width="100%" align="center" bgcolor="black" bordercolorlight="black">
				<div align="center">
				  <table border="0" cellspacing="1" width="100%" bordercolorlight="black" cellpadding="0">
					<tr>
					  <td width="100%" align="center" valign="middle"><A class="but" HREF="casino.php?casinogame=casino_forums&command=posttopic">{$l_forums_posttopic}</A>
					  </td>
					</tr>
				  </table>
				</div>
