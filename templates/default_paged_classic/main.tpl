...
<tr>
	...
	<td background="templates/{$templatename}images/topnav-bg.gif" width="100%" height="55" ID="IEshout" align="center" valign="middle">
...
<tr><td>
<img src="templates/{$templatename}images/spacer.gif" height="2">
</td></tr>
...
{if $show_newscrawl == 1}
<TABLE align="center" background="templates/{$templatename}images/topnav-mid.gif" height="55" width="492">
<tr>
	<td><img src="templates/{$templatename}images/spacer.gif" width="5"><td><TD align="center" height="50" width="100%" ID="IEnews">
<layer id="news"</layer>
{literal}
<SCRIPT LANGUAGE="JavaScript1.2" TYPE="text/javascript">
<!--
...
{/literal}
	</td><td><img src="templates/{$templatename}images/spacer.gif" width="5"></td>
</tr>
</table>
{/if}
