...
<tr>
	<td bgcolor="#000000" background="templates/{$templatename}images/spacer.gif" width="100%" ID="IEshout" align="center" valign="top">
...
<table cellspacing = "0" cellpadding = "0" border = "0" align="center">
<tr>
	<TD valign="top" align="center" bgcolor="#000000" bgcolor="templates/{$templatename}images/spacer.gif" width="100%" ID="IEnews">
<layer id="news"</layer>
	</td>
</tr>
</table>
...
</div><div id="frame_mininav" class="frame_mininav" style="border:0px outset #ffffff;background:#52ACEA;visibility:hidden;">
	</div>
