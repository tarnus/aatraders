<?php require_once('/home/aatrade_current/backends/template_lite/src/plugins/modifier.urlencode.php'); $this->register_modifier("urlencode", "tpl_modifier_urlencode");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2013-06-22 21:40:35 CDT */  echo '
...
<tr bgcolor="#52ACEA">
    ...
    <td colspan="6" height="1"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="1" height="1"></td>

  </tr>  
  <tr bgcolor="#000000">
    <td width="31" height="1"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="31" height="1"></td>
    <td   colspan="4"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="250" height="1"></td>
    
    <td width="12" height="1"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="12" height="1"></td>

  </tr>
  <tr bgcolor="#000000">
    <td  align="right" width="31" height="20"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="31" height="20"></td>
    <td   align="left" colspan="2" ID="IEshout1"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="250" height="1"><br><div style="border-style: dotted1none; border-color:white" id=scroll3 dir=rtl ;overflow:auto>
<?php echo '
...
'; ?>
    ...
    <td ID="IEfad1" align="right" colspan="2"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="250" height="1"><br><div style="border-style: dotted1none; border-color:white" id=scroll3 dir=rtl ;overflow:auto>
<?php echo '
<SCRIPT LANGUAGE="JavaScript1.2" TYPE="text/javascript">
<!--
...
'; ?>
    ...
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="12" height="20"></td>
  </tr>
  <tr bgcolor="#52ACEA">
...
.suckertreemenu .mainfoldericon{
	background: #3a3a3a url(templates/';  echo $this->_vars['templatename'];  echo 'images/arrow_down.gif) no-repeat center right;
}

/*Background image for subsequent level menu list links */
.suckertreemenu .subfoldericon{
	background: #3a3a3a url(templates/';  echo $this->_vars['templatename'];  echo 'images/arrow_right.gif) no-repeat center right;
}
...
<?php endif; ?>
			<li><a href="autotrades.php"><?php echo $this->_vars['l_autotrade']; ?></a></li>
...
<?php if ($this->_vars['galaxy_map_enabled'] == true && $this->_vars['gd_enabled'] == true && $this->_vars['enable_spiral_galaxy'] == 1): ?>
...
else
{
 ...
 ?>
  ...
  <tr bgcolor="#2A2A2A">
    ...
    <td colspan="6" height="3"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="1" height="3"></td>
...
<tr bgcolor="#52ACEA">
    ...
    <td colspan="5" height="1"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="1" height="1"></td>
...
<div style="background: no-repeat top  right url(<?php extract($this->_vars, EXTR_REFS);  
...
$startypes[5] = "templates/" . $templatename . "images/bluestar.gif";
 echo  $startypes[$starsize];  ?>) ;vertical-align: top; text-align: left; /*border: 1px solid white;*/">
<table width="100%" cellpadding=0 cellspacing=0 border=0 align=center>
<tr>
<td>&nbsp;</td>
<td>
...
<font color="white" size="2" face="arial"><b><?php echo $this->_vars['beacon']; ?></b></font>
</td><td align=right>
...
<td>
<tr><td>
<table border="1" cellspacing="0" cellpadding="0" align="left" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;"><tr><td><table  border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#000000" width="175">
...
<tr><td class=normal><?php echo $this->_vars['l_rank']; ?>: <img src="templates/<?php echo $this->_vars['templatename']; ?>images/rank/<?php echo $this->_vars['insignia']; ?>"></td></tr>
...
<tr><td><br>
<table bgcolor="#000000" border="1" cellpadding="4" cellspacing="0" align="left" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;">
<tr><td>
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_energy']; ?>" src="templates/<?php echo $this->_vars['templatename']; ?>images/energy.png">&nbsp;<?php echo $this->_vars['l_energy']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_fighters']; ?>" src="templates/<?php echo $this->_vars['templatename']; ?>images/tfighter.png">&nbsp;<a href=defense_deploy.php><?php echo $this->_vars['l_fighters']; ?></a></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_torps']; ?>" src="templates/<?php echo $this->_vars['templatename']; ?>images/torp.png">&nbsp;<a href=defense_deploy.php><?php echo $this->_vars['l_torps']; ?></a></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_armorpts']; ?>" src="templates/<?php echo $this->_vars['templatename']; ?>images/armor.png">&nbsp;<?php echo $this->_vars['l_armor']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_credits']; ?>" src="templates/<?php echo $this->_vars['templatename']; ?>images/credits.png">&nbsp;<?php echo $this->_vars['l_credits']; ?></td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<table border="1" cellspacing="0" cellpadding="0" align="left" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;"><tr><td><table  border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#000000" width="175">
  ...
  <tr>
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="10" height="21"></td>
    <td bgcolor="#000000"><font face="verdana" size="1" color="#ffffff"><b>
<?php echo $this->_vars['l_traderoutes']; ?>
</b></font></td>
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="10" height="21"></td>
  </tr>
  <tr>
...
<tr><td><br><table border="1" cellspacing="0" cellpadding="0" align="left" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;"><tr><td>
<table  border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#000000" width="175">

  <tr>
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="10" height="21"></td>
    <td bgcolor="#000000"><font face="verdana" size="1" color="#ffffff"><b>
<a class=mnu href="javascript:OpenSB()"><?php echo $this->_vars['shoutboxtitle']; ?></a>
</b></font></td>
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="10" height="21"></td>
  </tr>
  <tr>
	...
	<input type="Text" name="sbt"  class="shoutform" size="20" maxlength="250" onfocus="document.onkeypress = null;" ONBLUR="document.onkeypress = getKey;" ><input type="submit" name="go" value="Go" class="shoutform"><br>Public?&nbsp;
...
<tr align="center"><td>
<a href=port.php><img src="images/ports/port_<?php echo $this->_vars['port_type']; ?>.gif" border="0" alt=""><br></a><?php echo $this->_vars['portname']; ?>
</td>
	<?php if ($this->_vars['sector_location'] == 1): ?>
		<td><a href="casino.php?casinogame=casino_forums"><img src="images/ports/port_fedinfo.gif" border="0" alt=""></a><br><br><b><font color=#33ff00><?php echo $this->_vars['l_fedinfo']; ?></font></b></td>
	<?php endif; ?>
</tr>
</table>
...
<?php for($for1 = 0; ((0 < $this->_vars['countplanet']) ? ($for1 < $this->_vars['countplanet']) : ($for1 > $this->_vars['countplanet'])); $for1 += ((0 < $this->_vars['countplanet']) ? 1 : -1)):  $this->assign('i', $for1); ?>
	...
	<img src="templates/<?php echo $this->_vars['templatename']; ?>images/planet<?php echo $this->_vars['planetimg'][$this->_vars['i']]; ?>.png" alt="" width="100" height="100">
		...
		<?php if ($this->_vars['playercount'] != 0): ?>
			<?php for($for1 = 0; ((0 < $this->_vars['playercount']) ? ($for1 < $this->_vars['playercount']) : ($for1 > $this->_vars['playercount'])); $for1 += ((0 < $this->_vars['playercount']) ? 1 : -1)):  $this->assign('myLoop', $for1); ?>
   				<?php if ($this->_vars['shipprobe'][$this->_vars['myLoop']] == "ship"): ?>
					...
					<img src="templates/<?php echo $this->_vars['templatename']; ?>images/<?php echo $this->_vars['shipimage'][$this->_vars['myLoop']]; ?>.gif" border=0></a><BR>
...
<table border="1" cellspacing="0" cellpadding="0" align="left" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;"><tr><td><table  border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#000000" width="175">
  ...
  <tr>
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="10" height="21"></td>
    <td bgcolor="#000000"><font face="verdana" size="1" color="#ffffff"><b>
<?php echo $this->_vars['l_realspace']; ?>
</b></font></td>
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="10" height="21"></td>
  </tr>
  <tr>
...
<?php if ($this->_vars['xyminusp'][8] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[8]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][8]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][8]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][8]; ?> - <?php echo $this->_vars['altportx3'][8]; ?><br><?php echo $this->_vars['altturnsx3'][8]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][8]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[8]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[8]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][8]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][8]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>
<?php if ($this->_vars['xyminusp'][6] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[6]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][6]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][6]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][6]; ?> - <?php echo $this->_vars['altportx3'][6]; ?><br><?php echo $this->_vars['altturnsx3'][6]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][6]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[6]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[6]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][6]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][6]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>
<?php if ($this->_vars['xyminusp'][4] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[4]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][4]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][4]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][4]; ?> - <?php echo $this->_vars['altportx3'][4]; ?><br><?php echo $this->_vars['altturnsx3'][4]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][4]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[4]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[4]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][4]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][4]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
	<TD bgcolor=black rowspan="3" valign="bottom"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/nav_vert.gif"  border=0 width = "12" height = "36"></td>
<?php if ($this->_vars['xyplus'][4] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[4]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][4]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][4]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][4]; ?> - <?php echo $this->_vars['altportx1'][4]; ?><br><?php echo $this->_vars['altturnsx1'][4]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][4]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[4]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[4]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][4]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][4]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>
<?php if ($this->_vars['xyplus'][6] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[6]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][6]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][6]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][6]; ?> - <?php echo $this->_vars['altportx1'][6]; ?><br><?php echo $this->_vars['altturnsx1'][6]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][6]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[6]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[6]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][6]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][6]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
<?php if ($this->_vars['xyplus'][8] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[8]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][8]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][8]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][8]; ?> - <?php echo $this->_vars['altportx1'][8]; ?><br><?php echo $this->_vars['altturnsx1'][8]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][8]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[8]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[8]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][8]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][8]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
</tr>
...
<?php if ($this->_vars['xyminusp'][7] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[7]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][7]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][7]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][7]; ?> - <?php echo $this->_vars['altportx3'][7]; ?><br><?php echo $this->_vars['altturnsx3'][7]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][7]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[7]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[7]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][7]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][7]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>
<?php if ($this->_vars['xyminusp'][3] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[3]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][3]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][3]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][3]; ?> - <?php echo $this->_vars['altportx3'][3]; ?><br><?php echo $this->_vars['altturnsx3'][3]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][3]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[3]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[3]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][3]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][3]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
<?php if ($this->_vars['xyminusp'][1] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[1]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][1]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][1]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][1]; ?> - <?php echo $this->_vars['altportx3'][1]; ?><br><?php echo $this->_vars['altturnsx3'][1]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][1]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[1]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[1]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][1]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][1]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	

<?php if ($this->_vars['xyplus'][1] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[1]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][1]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][1]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][1]; ?> - <?php echo $this->_vars['altportx1'][1]; ?><br><?php echo $this->_vars['altturnsx1'][1]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][1]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[1]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[1]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][1]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][1]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
<?php if ($this->_vars['xyplus'][3] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[3]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][3]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][3]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][3]; ?> - <?php echo $this->_vars['altportx1'][3]; ?><br><?php echo $this->_vars['altturnsx1'][3]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][3]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[3]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[3]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][3]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][3]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>			
<?php if ($this->_vars['xyplus'][7] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[7]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][7]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][7]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][7]; ?> - <?php echo $this->_vars['altportx1'][7]; ?><br><?php echo $this->_vars['altturnsx1'][7]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][7]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[7]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[7]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][7]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][7]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>			
</tr>
...
<?php if ($this->_vars['xyminusp'][5] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[5]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][5]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][5]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][5]; ?> - <?php echo $this->_vars['altportx3'][5]; ?><br><?php echo $this->_vars['altturnsx3'][5]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][5]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[5]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[5]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][5]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][5]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>
<?php if ($this->_vars['xyminusp'][2] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[2]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][2]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][2]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][2]; ?> - <?php echo $this->_vars['altportx3'][2]; ?><br><?php echo $this->_vars['altturnsx3'][2]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][2]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[2]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[2]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][2]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][2]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
<?php if ($this->_vars['xyminusp'][0] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx3[0]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx3'][0]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx3'][0]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminusp'][0]; ?> - <?php echo $this->_vars['altportx3'][0]; ?><br><?php echo $this->_vars['altturnsx3'][0]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx3'][0]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx3[0]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[0]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex3'][0]; ?>.png" title="<?php echo $this->_vars['sectortitlex3'][0]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	

<?php if ($this->_vars['xyplus'][0] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[0]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][0]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][0]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][0]; ?> - <?php echo $this->_vars['altportx1'][0]; ?><br><?php echo $this->_vars['altturnsx1'][0]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][0]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[0]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[0]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][0]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][0]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
<?php if ($this->_vars['xyplus'][2] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[2]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][2]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][2]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][2]; ?> - <?php echo $this->_vars['altportx1'][2]; ?><br><?php echo $this->_vars['altturnsx1'][2]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][2]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[2]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[2]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][2]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][2]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
<?php if ($this->_vars['xyplus'][5] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx1[5]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx1'][5]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx1'][5]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplus'][5]; ?> - <?php echo $this->_vars['altportx1'][5]; ?><br><?php echo $this->_vars['altturnsx1'][5]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx1'][5]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx1[5]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[5]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex1'][5]; ?>.png" title="<?php echo $this->_vars['sectortitlex1'][5]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
</tr>
<tr bgcolor=black><td colspan="3" valign="middle" align="right"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/nav_horz.gif"  border=0 width = "48" height = "12"></td><td border=1 valign="middle" align="center"><A HREF="#" onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['sector']; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['ship_galacticarm']; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $ship_coordinates); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/yourhere.gif" border="0"></a></td><td colspan="3" align="left" valign="middle"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/nav_horz.gif"  border=0 width = "48" height = "12"></td></tr>
<tr>
<?php if ($this->_vars['xyminus'][4] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[4]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][4]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][4]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][4]; ?> - <?php echo $this->_vars['altportx2'][4]; ?><br><?php echo $this->_vars['altturnsx2'][4]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][4]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[4]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[4]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][4]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][4]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
<?php if ($this->_vars['xyminus'][2] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[2]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][2]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][2]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][2]; ?> - <?php echo $this->_vars['altportx2'][2]; ?><br><?php echo $this->_vars['altturnsx2'][2]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][2]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[2]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[2]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][2]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][2]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>
<?php if ($this->_vars['xyminus'][0] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[0]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][0]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][0]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][0]; ?> - <?php echo $this->_vars['altportx2'][0]; ?><br><?php echo $this->_vars['altturnsx2'][0]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][0]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[0]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[0]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][0]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][0]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
	<TD bgcolor=black rowspan="3" valign="top"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/nav_vert.gif"  border=0 width = "12" height = "36"></td>
<?php if ($this->_vars['xyplusm'][0] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[0]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][0]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][0]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][0]; ?> - <?php echo $this->_vars['altportx4'][0]; ?><br><?php echo $this->_vars['altturnsx4'][0]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][0]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[0]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[0]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][0]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][0]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
<?php if ($this->_vars['xyplusm'][2] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[2]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][2]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][2]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][2]; ?> - <?php echo $this->_vars['altportx4'][2]; ?><br><?php echo $this->_vars['altturnsx4'][2]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][2]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[2]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[2]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][2]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][2]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
<?php if ($this->_vars['xyplusm'][4] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[4]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][4]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][4]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][4]; ?> - <?php echo $this->_vars['altportx4'][4]; ?><br><?php echo $this->_vars['altturnsx4'][4]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][4]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[4]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[4]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][4]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][4]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
</tr>
...
<?php if ($this->_vars['xyminus'][6] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[6]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][6]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][6]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][6]; ?> - <?php echo $this->_vars['altportx2'][6]; ?><br><?php echo $this->_vars['altturnsx2'][6]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][6]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[6]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[6]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][6]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][6]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
<?php if ($this->_vars['xyminus'][1] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[1]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][1]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][1]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][1]; ?> - <?php echo $this->_vars['altportx2'][1]; ?><br><?php echo $this->_vars['altturnsx2'][1]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][1]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[1]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[1]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][1]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][1]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	

<?php if ($this->_vars['xyminus'][3] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[3]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][3]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][3]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][3]; ?> - <?php echo $this->_vars['altportx2'][3]; ?><br><?php echo $this->_vars['altturnsx2'][3]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][3]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[3]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[3]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][3]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][3]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		

<?php if ($this->_vars['xyplusm'][3] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[3]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][3]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][3]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][3]; ?> - <?php echo $this->_vars['altportx4'][3]; ?><br><?php echo $this->_vars['altturnsx4'][3]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][3]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[3]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[3]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][3]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][3]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
<?php if ($this->_vars['xyplusm'][1] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[1]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][1]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][1]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][1]; ?> - <?php echo $this->_vars['altportx4'][1]; ?><br><?php echo $this->_vars['altturnsx4'][1]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][1]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[1]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[1]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][1]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][1]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
<?php if ($this->_vars['xyplusm'][6] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[6]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][6]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][6]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][6]; ?> - <?php echo $this->_vars['altportx4'][6]; ?><br><?php echo $this->_vars['altturnsx4'][6]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][6]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[6]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[6]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][6]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][6]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>				
</tr>
...
<?php if ($this->_vars['xyminus'][8] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[8]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][8]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][8]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][8]; ?> - <?php echo $this->_vars['altportx2'][8]; ?><br><?php echo $this->_vars['altturnsx2'][8]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][8]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[8]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[8]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][8]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][8]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
<?php if ($this->_vars['xyminus'][7] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[7]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][7]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][7]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][7]; ?> - <?php echo $this->_vars['altportx2'][7]; ?><br><?php echo $this->_vars['altturnsx2'][7]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][7]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[7]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[7]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][7]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][7]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>		
<?php if ($this->_vars['xyminus'][5] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx2[5]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx2'][5]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx2'][5]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyminus'][5]; ?> - <?php echo $this->_vars['altportx2'][5]; ?><br><?php echo $this->_vars['altturnsx2'][5]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx2'][5]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx2[5]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[5]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex2'][5]; ?>.png" title="<?php echo $this->_vars['sectortitlex2'][5]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	

<?php if ($this->_vars['xyplusm'][5] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[5]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][5]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][5]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][5]; ?> - <?php echo $this->_vars['altportx4'][5]; ?><br><?php echo $this->_vars['altturnsx4'][5]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][5]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[5]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[5]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][5]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][5]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	

<?php if ($this->_vars['xyplusm'][7] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[7]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][7]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][7]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][7]; ?> - <?php echo $this->_vars['altportx4'][7]; ?><br><?php echo $this->_vars['altturnsx4'][7]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][7]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[7]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[7]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][7]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][7]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>	
	
<?php if ($this->_vars['xyplusm'][8] != ""): ?>
		<?php extract($this->_vars, EXTR_REFS);  $warp_links = str_replace("|", "<br>", $link_listx4[8]); ?>
		<TD bgcolor=<?php echo $this->_vars['sectorzonecolorx4'][8]; ?>><A HREF=main.php?move_method=real&engage=1&destination=<?php echo $this->_vars['altsectorx4'][8]; ?> onMouseover="ddrivetip('<?php echo $this->_vars['l_sector']; ?>: <?php echo $this->_vars['xyplusm'][8]; ?> - <?php echo $this->_vars['altportx4'][8]; ?><br><?php echo $this->_vars['altturnsx4'][8]; ?>','<?php echo $this->_vars['l_galacticarm']; ?>: <?php echo $this->_vars['galacticarmx4'][8]; ?><br><br><?php extract($this->_vars, EXTR_REFS);   $coords = explode("|", $nav_scan_coordsx4[8]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[8]<br><br>$l_links:<br>$warp_links" ?>');" onMouseout="hideddrivetip()"><img src="images/ports/<?php echo $this->_vars['sectorimagex4'][8]; ?>.png" title="<?php echo $this->_vars['sectortitlex4'][8]; ?>" border=0 width = "12" height = "12"></A></TD>
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif; ?>				
...
<option value="main.php?move_method=real&engage=1&destination=<?php echo $this->_run_modifier($this->_vars['lastsectors'][0], 'urlencode', 'plugin', 1); ?>"><?php echo $this->_vars['lastsectors'][0]; ?>(<?php echo $this->_vars['lastsectorsdist'][0]; ?>)</option>
<?php endif; ?>
<?php if ($this->_vars['lastsectors'][1] != ""): ?>
<option value="main.php?move_method=real&engage=1&destination=<?php echo $this->_run_modifier($this->_vars['lastsectors'][1], 'urlencode', 'plugin', 1); ?>"><?php echo $this->_vars['lastsectors'][1]; ?>(<?php echo $this->_vars['lastsectorsdist'][1]; ?>)</option>
<?php endif; ?>
<?php if ($this->_vars['lastsectors'][2] != ""): ?>
<option value="main.php?move_method=real&engage=1&destination=<?php echo $this->_run_modifier($this->_vars['lastsectors'][2], 'urlencode', 'plugin', 1); ?>"><?php echo $this->_vars['lastsectors'][2]; ?>(<?php echo $this->_vars['lastsectorsdist'][2]; ?>)</option>
<?php endif; ?>
<?php if ($this->_vars['lastsectors'][3] != ""): ?>
<option value="main.php?move_method=real&engage=1&destination=<?php echo $this->_run_modifier($this->_vars['lastsectors'][3], 'urlencode', 'plugin', 1); ?>"><?php echo $this->_vars['lastsectors'][3]; ?>(<?php echo $this->_vars['lastsectorsdist'][3]; ?>)</option>
<?php endif; ?>
<?php if ($this->_vars['lastsectors'][4] != ""): ?>
<option value="main.php?move_method=real&engage=1&destination=<?php echo $this->_run_modifier($this->_vars['lastsectors'][4], 'urlencode', 'plugin', 1); ?>"><?php echo $this->_vars['lastsectors'][4]; ?>(<?php echo $this->_vars['lastsectorsdist'][4]; ?>)</option>
<?php endif; ?>
</select></form></td></tr>
...
<table border="1" cellspacing="0" cellpadding="0" align="left" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;"><tr><td><table  border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#000000" width="175">
  ...
  <tr>
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="10" height="21"></td>
    <td bgcolor="#000000"><font face="verdana" size="1" color="#ffffff"><b>
<?php echo $this->_vars['l_main_warpto']; ?>
</b></font></td>
    <td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="10" height="21"></td>
  </tr>
  <tr>
