<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2013-06-22 21:39:48 CDT */  if ($this->_vars['new_posts'] > 0): ?> 
	<?php echo '
	<style type="text/css">
...
.suckertreemenu .mainfoldericon{
	background: #4455aa url(templates/';  echo $this->_vars['templatename'];  echo 'images/arrow_down.gif) no-repeat center right;
}

/*Background image for subsequent level menu list links */
.suckertreemenu .subfoldericon{
	background: #4455aa url(templates/';  echo $this->_vars['templatename'];  echo 'images/arrow_right.gif) no-repeat center right;
}
...
<tr>
	<td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/topnav-left.gif" width="41" height="55"></td>
	<td background="templates/<?php echo $this->_vars['templatename']; ?>images/topnav-bg.gif" width="100%" height="55" ID="IEshout" align="center">
<layer id="shout"</layer>
	</td>
	<td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/topnav-right.gif" width="22" height="55"></td>
</tr>
</table>
...
<table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
		<td width=18><img src = "templates/<?php echo $this->_vars['templatename']; ?>images/g-top-left.gif"></td>
		<td width=101><img src = "templates/<?php echo $this->_vars['templatename']; ?>images/g-top-midleft.gif"></td>
		<td width="100%"><img src = "templates/<?php echo $this->_vars['templatename']; ?>images/g-top-midright.gif" width="100%" height="20"></td>
		<td width=18><img src = "templates/<?php echo $this->_vars['templatename']; ?>images/g-top-right.gif"></td>
  </tr>
  <tr>
    <td background="templates/<?php echo $this->_vars['templatename']; ?>images/g-mid-left.gif">&nbsp;</td>
...
<tr>
   ...
   <font color="silver" size=3 face="arial"><img src="templates/<?php echo $this->_vars['templatename']; ?>images/rank/<?php echo $this->_vars['insignia']; ?>" height="18">
	<b>
  ...
  <?php echo $this->_vars['l_abord']; ?>
   <b>
    ...
    <td background="templates/<?php echo $this->_vars['templatename']; ?>images/g-mid-right.gif">&nbsp;</td>
  </tr>
  <tr>
		<td width=18><img src = "templates/<?php echo $this->_vars['templatename']; ?>images/g-bottom-left.gif"></td>
		<td width=101><img src = "templates/<?php echo $this->_vars['templatename']; ?>images/g-bottom-midleft.gif"></td>
		<td width="100%"><img src = "templates/<?php echo $this->_vars['templatename']; ?>images/g-bottom-midright.gif" width="100%" height="12"></td>
		<td width=18><img src = "templates/<?php echo $this->_vars['templatename']; ?>images/g-bottom-right.gif"></td>
  </tr>
</table>
...
<tr>
	<td><img src="templates/<?php echo $this->_vars['templatename']; ?>images/topnav-left.gif" width="41" height="55"></td>
	<td background="templates/<?php echo $this->_vars['templatename']; ?>images/topnav-bg.gif" width="100%" height="55" ID="IEnews" align="center">
<layer id="news"</layer>
<?php echo '
<SCRIPT LANGUAGE="JavaScript1.2" TYPE="text/javascript">
<!--
