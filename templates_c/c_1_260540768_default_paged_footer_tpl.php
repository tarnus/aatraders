<?php require_once('/home/aatrade_current/backends/template_lite/src/plugins/modifier.string_format.php'); $this->register_modifier("string_format", "tpl_modifier_string_format");  require_once('/home/aatrade_current/backends/template_lite/src/plugins/modifier.strip.php'); $this->register_modifier("strip", "tpl_modifier_strip");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2013-06-22 21:39:27 CDT */  if ($this->_vars['instantmessagecount'] > 0): ?> 
	<?php echo '
	<style type="text/css">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td class="footer"><div>&nbsp;&nbsp;<a href="http://www.aatraders.com"><?php echo $this->_vars['l_footer_title']; ?></a></div><div>&nbsp;&nbsp;<a href="http://www.springfield.net">Springfield Net</a></div></td>
...
<li class="facebook"> <a target="_blank" href="http://www.facebook.com/aatrade"></a> </li> 
 <li class="twitter"><a target="_blank" href="https://twitter.com/#!/aatrade"></a> </li>
   ...
   <div style="clear:both;"> &#169; 2003-<?php extract($this->_vars, EXTR_REFS);  echo date("Y"); ?> <a href="docs/copyright.htm">AATRADE Development Group</a>&nbsp;&nbsp;</div>
   
    </td>
 </tr>
  <tr> 
    <td class="footer">&nbsp;&nbsp;</td>
    <td  valign="top" align="center" class="footer" width="34%"><?php echo $this->_vars['l_footer_onlinereset']; ?> <?php echo $this->_vars['onlinetime_reset']; ?></td>
...
<SCRIPT language=javascript>
	...
	<?php $this->_foreach['foreach1'] = array('total' => count((array)$this->_vars['query_list']), 'iteration' => 0);
if (count((array)$this->_vars['query_list'])): foreach ((array)$this->_vars['query_list'] as $this->_vars['key'] => $this->_vars['sql']): $this->_foreach['foreach1']['iteration']++;
 ?>
		_query_debug_console.document.write("<tr bgcolor=<?php if ($this->_vars['key'] % 2): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>>");
		_query_debug_console.document.write('<td width="75%"><?php echo $this->_run_modifier($this->_run_modifier($this->_vars['query_list'][$this->_vars['key']], 'strip', 'plugin', 1), 'addslashes', 'PHP', 1); ?><hr><font color=\"red\"><b><?php echo $this->_run_modifier($this->_run_modifier($this->_vars['query_list_errors'][$this->_vars['key']], 'strip', 'plugin', 1), 'addslashes', 'PHP', 1); ?></b></font></td>');
		_query_debug_console.document.write("<td width=\"25%\"><font color=\"red\"><b><i>(<?php echo $this->_run_modifier($this->_vars['query_list_time'][$this->_vars['key']], 'string_format', 'plugin', 1, "%.5f"); ?> seconds)</i></b></font></td></tr>");
