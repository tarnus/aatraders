<?php require_once('/home/aatrade_current/backends/template_lite/src/plugins/modifier.string_format.php'); $this->register_modifier("string_format", "tpl_modifier_string_format");  require_once('/home/aatrade_current/backends/template_lite/src/plugins/modifier.strip.php'); $this->register_modifier("strip", "tpl_modifier_strip");  if ($this->_vars['instantmessagecount'] > 0): ?> 
	<?php echo '
	<style type="text/css">
