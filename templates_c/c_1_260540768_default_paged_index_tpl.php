<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2013-06-22 21:39:27 CDT */ ?>
...
<param name="movie" value="templates/';  echo $this->_vars['templatename'];  echo 'images/aat-title.swf" />
<param name="quality" value="high" />
<param name="bgcolor" value="#000000" />
<embed src="templates/';  echo $this->_vars['templatename'];  echo 'images/aat-title.swf" quality="high" bgcolor="#000000" width="650" height="300" name="3D Solar System" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>
'; ?>
...
<font color="#49A7DD" size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>[Version <?php echo $this->_vars['version']; ?>]</b></font><br><br>
<?php print "
<div style=\"position:relative;width: 400px;margin:0 auto; padding:10px;\">
...
<script type=\"text/javascript\" src=\"http://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-4f282a0d76b9f5ae\"></script>
<!-- AddThis Button END -->
...
<table border="0" align="center">
  <tr onMouseover="ddrivetip('Player Name', 'Enter your Ship Captain\'s name for the selected game to take command of your ship.<br><br>If you are a new player click on the New Player button to be assigned a ship.');" onMouseout="hideddrivetip()">
	<td width="200" height="23"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/playername.gif"></td>
	<td width="250" background="templates/<?php echo $this->_vars['templatename']; ?>images/loginbox.png">
		<p align="center">
		<input type="text" name="character_name" value="<?php echo $this->_vars['character_name']; ?>" size="32" maxlength="30" style="color:#52ACEA; font-weight: bold; background-color:black; text-align:left; border-style:none;">
		</p>
	</td>
  </tr>
  <tr onMouseover="ddrivetip('Player Password', 'Enter your Ship Captain\'s password to login to your ships computer systems.');" onMouseout="hideddrivetip()">
	<td width="200" height="23"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/password.gif"></td>
	<td width="250" background="templates/<?php echo $this->_vars['templatename']; ?>images/loginbox.png">
		<p align="center">
		<input type="password" name="pass" value="<?php echo $this->_vars['password']; ?>" size="32" maxlength="<?php echo $this->_vars['maxlen_password']; ?>" style="color:#52ACEA; font-weight:bold; background-color:black; text-align:left; border-style:none;">
		</p>
	</td>
  </tr>
 </table>
...
<table border="0" align="center">
  <tr>
	<td colspan="3" align="center"><br><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/gameselection.gif" alt="Select Game"></td>
	</tr>
	<tr>
...
<table border="0" align="center">
  <tr>
	...
	<a id="newplayer" href="new_player.php"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/newplayer.gif" align="left"></a>
	</td>
	<?php endif; ?>
...
<table border="0" align="center">
  <tr>
	<td width="118" align="right"><a onMouseover="ddrivetip('Forum Access', 'Click here to view the Forums provided for this game.');" onMouseout="hideddrivetip()" href="<?php echo $this->_vars['link_forums']; ?>" target="_blank"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/forums.gif"></a></td>
<?php if ($this->_vars['main_site'] != ''): ?>
	 <td width="134" align="right">
	  <a onMouseover="ddrivetip('Web Site', 'Click here to be taken to the Web Site for this game.');" onMouseout="hideddrivetip()" href="<?php echo $this->_vars['main_site']; ?>" target="_blank"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/returntosite.gif"></a>
	 </td>
<?php endif; ?>

<?php if ($this->_vars['serverlist'] != ''): ?>
	 <td width="134" align="right">
	  <a onMouseover="ddrivetip('Server List', 'Click here to view a list of all servers running Alien Assault Traders games.');" onMouseout="hideddrivetip()" href="<?php echo $this->_vars['serverlist']; ?>servers" target="_blank"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/serverlist.gif"></a>
	 </td>
<?php endif; ?>
	<td width="70" align="right"><a onMouseover="ddrivetip('FAQ', 'Click here to view a simple F.A.Q. about the game.');" onMouseout="hideddrivetip()" href="http://wiki.aatraders.com/tiki-index.php?page=Playing+the+Game" target="_blank"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/faq.gif"></a></td>
  </tr>
<tr>
		<td colspan="4" align="center"><a onMouseover="ddrivetip('Contact Admin', 'Click here to send an Email to the Admin of this game.');" onMouseout="hideddrivetip()" href="contact_admin.php" target="_blank"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/contact.gif"><img border="0" src="templates/<?php echo $this->_vars['templatename']; ?>images/contact_admin.gif"></a></td>
</tr>
</table>
</form>
</center>

<?php if ($this->_vars['showserverlist'] == 1 && $this->_vars['servercount'] > 0): ?>
